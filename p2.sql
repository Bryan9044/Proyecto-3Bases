...
CREATE TABLE Zona (
	Nombre VARCHAR(20) UNIQUE NOT NULL, -- Nombre único de la zon
...
--drop view verCasosComparativo





-- Consulta para ver el resultado de la vista
--SELECT * FROM verCasosComparativo;
...
CREATE TABLE Caso (
	...
	Fecha date, -- Prioridad asignada al caso.
...
INSERT INTO Caso (CodigoCaso, PropietarioCaso, OrigenCasoC, OrigenCasoF, NombreCuenta, NombreContacto, Asunto, Direccion, Descripcion, EstadoCaso, TipoCaso, Prioridad, Fecha) VALUES
('CS1', '123456789', 1, null, 'Salamar','Salamar', 'Necesitamos una ayuda inmediata', 'San jose en el centro de la capital', 'Se tiene que verificar el tipo de ayuda que necesita', 'Abierta', 'Reclamo', 'Alta', '2022-05-10'),
('CS2', '325543227', 2, null, 'Dospinos','Dospinos', 'Queremos hablar con un encargado', 'Alajuela a un costado del mercado', 'Se procedera a enviar la queja al encargado', 'Aprobado', 'Devolucion', 'Alta', '2023-08-15'),
('CS3', '456789123', 3, null, 'Aurua','Aurua', 'Tuvimos problemas', 'En San carlos debajo de una catarata', 'Se busca el tipo de problemas', 'Rechazado', 'Garantia', 'Baja', '2023-12-20'),
('CS4', '321654987', 4, null, 'Dianeys','Dianeys', 'Hubo un problema', 'En la casa habitacion #58 en limon', 'Se habla para ver el problema', 'Aprobado', 'Garantia', 'Baja', '2022-06-30'),
('CS5', '754323489', 5, null, 'Nike','Nike', 'Algo fallo en los pedidos', 'San jose a la par de amazon', 'Se indica el fallo que hubo', 'Abierta', 'Reclamo', 'Media', '2024-01-05'),
('CS6', '432124368', 6, null, 'Adidas','Adidas', 'Es un asunto de urgencia', 'San jose por el mall san pedro', 'Se habla con el administrador', 'Rechazado', 'Reclamo', 'Media', '2023-10-22'),
('CS7', '153234558', 7, null, 'Cerveza del Valle','Cerveza del Valle', 'Solicito reposición', 'Cartago, frente al parque central', 'Reposición de producto defectuoso', 'Abierta', 'Garantia', 'Alta', '2024-04-12'),
('CS8', '533467853', 8, null, 'Zapatos Rápidos','Zapatos Rápidos', 'Problema con la talla', 'Heredia, calle principal', 'Cambio de talla solicitado', 'Aprobado', 'Reclamo', 'Baja', '2022-09-17'),
('CS9', '258932147', 9, null, 'Panadería El Buen Pan','Panadería El Buen Pan', 'Falta de producto', 'San Jose, barrio Escalante', 'Falta de producto en el pedido', 'Abierta', 'Devolucion', 'Media', '2023-02-03'),
('CS10', '369253247', 10, null, 'Supermercados La Familia','Supermercados La Familia', 'Pedido incompleto', 'Alajuela, zona sur', 'Se confirma que faltan productos', 'Aprobado', 'Reclamo', 'Alta', '2022-07-01'),
('CS11', '235754438', 11, null, 'Muebles Modernos','Muebles Modernos', 'Pedido equivocado', 'Puntarenas, frente a la playa', 'Se corrige el error y se envía el producto correcto', 'Abierta', 'Garantia', 'Media', '2024-03-18'),
('CS12', '754332564', 12, null, 'Tecnología Avanzada','Tecnología Avanzada', 'Equipos defectuosos', 'San jose, zona oeste', 'Se ofrece reemplazo por otro equipo', 'Aprobado', 'Garantia', 'Alta', '2023-11-01'),
('CS13', '432123478', 13, null, 'Electricidad Total','Electricidad Total', 'Daño en el equipo', 'Alajuela, zona norte', 'Se verifican detalles del daño para la reparación', 'Abierta', 'Garantia', 'Baja', '2023-05-21'),
('CS14', '564298645', 14, null, 'Casa y Hogar','Casa y Hogar', 'Problema con los materiales', 'Cartago, sector El Tejar', 'Se solicita cambio por materiales dañados', 'Rechazado', 'Reclamo', 'Baja', '2024-02-10'),
('CS15', '354215796', 15, null, 'Comida Rápida','Comida Rápida', 'Error en la entrega', 'Heredia, frente al colegio', 'Se informa sobre el error en la entrega', 'Abierta', 'Reclamo', 'Media', '2023-06-08'),
('CS16', '642342123', 16, null, 'Tecnología Total','Tecnología Total', 'Mal funcionamiento', 'San jose, centro comercial', 'Se solicita revisar la falla técnica', 'Aprobado', 'Garantia', 'Alta', '2022-08-25'),
('CS17', '653212356', 17, null, 'Suministros Industriales','Suministros Industriales', 'Daño en el equipo', 'Alajuela, zona industrial', 'Se envia técnico para revisar el equipo', 'Abierta', 'Garantia', 'Baja', '2024-04-01'),
('CS18', '257543123', 18, null, 'Lentes Ópticos','Lentes Ópticos', 'Montura rota', 'San jose, Avenida central', 'Se autoriza la reposición del producto', 'Rechazado', 'Garantia', 'Baja', '2022-10-12'),
('CS19', '321234678', 19, null, 'Libros Online','Libros Online', 'Pedido erróneo', 'Cartago, cerca del parque', 'Se procederá con la devolución del producto', 'Aprobado', 'Devolucion', 'Media', '2023-09-30'),
('CS20', '123456789', 20, null, 'Tecnología y Accesorios','Tecnología y Accesorios', 'Reemplazo de producto', 'Puntarenas, frente al puerto', 'Se ofrece la reposición del artículo dañado', 'Rechazado', 'Garantia', 'Alta', '2024-01-20'),
('CS21', '325543227', null, 'FAC1', 'Decoraciones de Lujo','Decoraciones de Lujo', 'Pedido incompleto', 'Heredia, zona comercial', 'Faltan algunos artículos en el pedido', 'Abierta', 'Reclamo', 'Alta', '2023-11-05'),
('CS22', '456789123', null, 'FAC2', 'Automóviles Ágiles','Automóviles Ágiles', 'Problema con el servicio', 'San jose, barrio la estrella', 'Se solicitará revisión por el equipo de servicio', 'Abierta', 'Garantia', 'Media', '2024-03-22'),
('CS23', '321654987', null, 'FAC3', 'Cosméticos Naturales','Cosméticos Naturales', 'Producto defectuoso', 'Alajuela, cerca de la estación de buses', 'Se reemplaza el producto defectuoso', 'Aprobado', 'Garantia', 'Baja', '2022-11-11'),
('CS24', '754323489', null, 'FAC4', 'Farmacia Salud Total','Farmacia Salud Total', 'Error en receta', 'Cartago, centro comercial', 'Se enviará corrección a la receta', 'Abierta', 'Devolucion', 'Baja', '2023-07-09'),
('CS25', '432124368', null, 'FAC5', 'Juguetes Divertidos','Juguetes Divertidos', 'Pedido retrasado', 'San jose, zona este', 'Se solicita investigar retraso en la entrega', 'Abierta', 'Reclamo', 'Media', '2024-06-15'),
('CS26', '153234558', null, 'FAC6', 'Ropa Elegante','Ropa Elegante', 'Cambio de talla', 'Puntarenas, sector norte', 'Se procederá con el cambio de talla', 'Rechazado', 'Reclamo', 'Baja', '2023-08-09'),
('CS27', '533467853', null, 'FAC7', 'Zapatos de Cuero','Zapatos de Cuero', 'Producto no encontrado', 'Heredia, cerca del hospital', 'Se busca alternativa de producto', 'Aprobado', 'Devolucion', 'Alta', '2022-12-14'),
('CS28', '258932147', null, 'FAC8', 'Electrodomésticos Premium','Electrodomésticos Premium', 'Falla en la nevera', 'Alajuela, zona comercial', 'Se ofrece reparación o sustitución', 'Abierta', 'Garantia', 'Alta', '2024-02-27'),
('CS29', '369253247', null, 'FAC9', 'Lentes de Sol','Lentes de Sol', 'Pedido incompleto', 'San jose, frente a la plaza de deportes', 'Se enviará el pedido completo', 'Rechazado', 'Reclamo', 'Baja', '2023-11-23'),
('CS30', '235754438', null, 'FAC10', 'Tecnología Smart','Tecnología Smart', 'Dispositivo defectuoso', 'Heredia, frente a la universidad', 'Se procede con la devolución y reembolso', 'Aprobado', 'Garantia', 'Media', '2023-03-02'),
('CS31', '754332564', null, 'FAC11', 'Productos Lácteos', 'Productos Lácteos', 'Envío tardío', 'Alajuela, zona sur', 'Se investiga el motivo del retraso', 'Abierta', 'Reclamo', 'Alta', '2024-11-17'),
('CS32', '432123478', null, 'FAC12', 'Restaurante El Buen Comer', 'Restaurante El Buen Comer', 'Problema con ingredientes', 'Heredia, zona norte', 'Se sustituirán los ingredientes defectuosos', 'Rechazado', 'Garantia', 'Baja', '2024-11-16'),
('CS33', '564298645', null, 'FAC13', 'Moda Actual', 'Moda Actual', 'Cambio de producto', 'Puntarenas, sector sur', 'Se procederá con el cambio por otro artículo', 'Aprobado', 'Reclamo', 'Media', '2024-11-15'),
('CS34', '354215796', null, 'FAC14', 'Tiendas Naturales', 'Tiendas Naturales', 'Error en cantidad de producto', 'San jose, barrio los alamos', 'Se enviará la cantidad faltante', 'Abierta', 'Devolucion', 'Baja', '2024-11-14'),
('CS35', '642342123', null, 'FAC15', 'Salud y Bienestar', 'Salud y Bienestar', 'Problema con el medicamento', 'Cartago, zona este', 'Se procederá a la devolución del medicamento', 'Aprobado', 'Devolucion', 'Alta', '2024-11-13'),
('CS36', '653212356', null, 'FAC16', 'Instrumentos Musicales', 'Instrumentos Musicales', 'Producto en mal estado', 'Alajuela, zona céntrica', 'Se procederá con la devolución y reposición', 'Rechazado', 'Garantia', 'Alta', '2024-11-12'),
('CS37', '257543123', null, 'FAC17', 'Tienda Digital', 'Tienda Digital', 'Problemas con la facturación', 'San jose, calle 13', 'Se revisarán los datos de facturación', 'Aprobado', 'Devolucion', 'Media', '2024-11-11'),
('CS38', '123456789', null, 'FAC18', 'Bebidas Naturales', 'Bebidas Naturales', 'Producto defectuoso', 'Heredia, sector las flores', 'Se reemplaza el producto defectuoso', 'Abierta', 'Garantia', 'Alta', '2024-11-10'),
('CS39', '325543227', null, 'FAC19', 'Carpintería El Mueble', 'Carpintería El Mueble', 'Falla en la entrega', 'Puntarenas, zona oeste', 'Se confirmará la fecha de entrega', 'Aprobado', 'Reclamo', 'Baja', '2024-11-09'),
('CS40', '456789123', null, 'FAC20', 'Electrodomésticos Rápidos', 'Electrodomésticos Rápidos', 'Error en el tipo de artículo', 'San jose, barrio los laureles', 'Se autoriza el cambio del artículo erróneo', 'Rechazado', 'Devolucion', 'Baja', '2024-11-08');
...
group by 
	...
	go
CREATE VIEW verCasosComparativo AS
SELECT 
    YEAR(c.Fecha) AS Anio,                         -- Año del caso
    MONTH(c.Fecha) AS Mes,                         -- Mes del caso
    COUNT(DISTINCT c.CodigoCaso) AS CantidadCasos,  -- Cantidad total de casos
    COUNT(DISTINCT cc.CodigoCaso) AS CantidadCasosPorCotizacion, -- Casos con cotización
    COUNT(DISTINCT cf.CodigoCaso) AS CantidadCasosPorFactura    -- Casos con factura
FROM Caso c
LEFT JOIN Caso cc ON c.CodigoCaso = cc.CodigoCaso AND c.OrigenCasoC IS NOT NULL -- Casos con cotización
LEFT JOIN Caso cf ON c.CodigoCaso = cf.CodigoCaso AND c.OrigenCasoF IS NOT NULL -- Casos con factura
GROUP BY 
    YEAR(c.Fecha), 
    MONTH(c.Fecha);
...
go
create nonclustered index IDListaCotizacionCodigoProducto --este lo usa cotizacionesMes
on ListaCotizacion(CodigoProducto);

go
create nonclustered index IDCotizacionCodigo  --este lo usa cotizacionesMes
on Cotizacion(Codigo);
go
create nonclustered index IDCotizacionFechaCotizacion
on Cotizacion(FechaCotizacion);

go
create nonclustered index IDListaFacturaCodigo  --este lo usa VentasMes
on ListaFactura(Codigo);
go
create nonclustered index IDListaFacturaCodigoF -- este lo usa VentasMes
on ListaFactura(CodigoF);


--drop index IDListaCotizacionCodigoProducto on ListaCotizacion;
--drop index IDCotizacionCodigo on Cotizacion;
--drop index IDListaFacturaCodigo on ListaFactura;
--drop index IDListaFacturaCodigoF on ListaFactura;
--drop index IDCotizacionFechaCotizacion on FechaCotizacion;
